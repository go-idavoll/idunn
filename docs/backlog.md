...
| [IDN-39](idn/IDN-39.md) | Probation: a new version confirms it is healthy, or is rolled back (§6.1, §6.2, §14.3, §14.5) | mechanism done with a host policy; signed per-release allowance and telemetry open |
