...
| [IDN-39](idn/IDN-39.md) | Probation: a new version confirms it is healthy, or is rolled back (§6.1, §6.2, §14.3, §14.5) | open |
| [IDN-40](idn/IDN-40.md) | Windows: the launcher as the application's parent — job object and console control events (§6.1, §13, §14.3) | open |
