...
| §6.3 | Updater API (`CheckForUpdate`, `Apply`) | **done** — `Apply` installs the releases a migration floor demands in between, in order, each its own transaction (§6.4) |
